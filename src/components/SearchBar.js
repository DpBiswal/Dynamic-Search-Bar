...
function SearchBar() {
    ...
    return (
        <div className="container mt-5">
            <h1 className="mb-4">Search for a Country or Capital</h1>
            <div className="search-container d-flex align-items-center">
                ...
                <div className="icons-container d-flex align-items-center">
                    <FontAwesomeIcon icon={faMicrophone} className="search-icon" />
                    <FontAwesomeIcon icon={faCamera} className="search-icon" />
                </div>
            </div>
